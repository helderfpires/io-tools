...
public class FileFormatCollection extends SimpleElement {
    List<DroidFileFormat> formats = new ArrayList<DroidFileFormat>();

    /* setters */
    public void addFileFormat(DroidFileFormat format) {
        formats.add(format);
    }

    public void setFileFormats(List<DroidFileFormat> formats) {
