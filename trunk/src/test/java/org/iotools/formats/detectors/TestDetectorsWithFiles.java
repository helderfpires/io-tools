...
public class TestDetectorsWithFiles extends TestCase {
	...
	private static void checkDetector(final Detector detector,
		...
		for (final String fileName : goodFiles) {
			final InputStream is = TestDetectorsWithFiles.class
	...
	static String[] listFilesExcludingExtension(final String[] forbidden)
			throws Exception {
		final URL fileURL = TestDetectorsWithFiles.class.getResource(".");
