...
public abstract class ReaderFromWriter<T> extends Reader {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(ReaderFromWriter.DataProducer.class);
	...
	public static final String[] getActiveThreadNames() {
		...
		synchronized (ReaderFromWriter.ACTIVE_THREAD_NAMES) {
			result = ReaderFromWriter.ACTIVE_THREAD_NAMES
	 ...
	 *            Defines how the internal thread is allocated.
	 */
	public ReaderFromWriter(final ExecutionModel executionModel) {
