 ...
 * Tessella/NPD/4305 PRONOM 4 $Id: FFSignatureFile.java,v 1.6 2006/03/13
 * 15:15:29 linb Exp $ $Logger: FFSignatureFile.java,v $ Revision 1.6
 ...
 * 2005-2006 Revision 1.5 2006/02/07 17:16:22 linb - Change fileReader to
 * ByteReader in formal parameters of methods - use new static constructors -
 * Add detection of if a filePath is a URL or not Revision 1.4 2006/02/07
 * 12:34:57 gaur Removed restriction on priority relationships so that they
 * can be applied between any combination of generic and specific signatures
 * (second recommit because of missing logging) $History: FFSignatureFile.java
 * $ ***************** Version 7 ***************** User: Walm Date: 19/04/05
 * Time: 18:24 Updated in $/PRONOM4/FFIT_SOURCE/signatureFile Provide initial
 * values for version and dateCreated ***************** Version 6
 * ***************** User: Walm Date: 18/03/05 Time: 12:39 Updated in
 * $/PRONOM4/FFIT_SOURCE/signatureFile add some more exception handling
 * ***************** Version 5 ***************** User: Walm Date: 15/03/05
 * Time: 14:39 Updated in $/PRONOM4/FFIT_SOURCE/signatureFile fileReader class
 * now holds reference to identificationFile object ***************** Version
 * 4 ***************** User: Mals Date: 14/03/05 Time: 15:08 Updated in
 * $/PRONOM4/FFIT_SOURCE/signatureFile Takes into account of
 * IdentificationFile objects in checkExtension ***************** Version 3
 * ***************** User: Mals Date: 14/03/05 Time: 14:30 Updated in
 * $/PRONOM4/FFIT_SOURCE/signatureFile runFileIdentification accepts
 * IdentificationFile parameter
 */
...
public class FFSignatureFile extends SimpleElement {
	...
	public FFSignatureFile(final Collection<FileFormat> fcollection,
			final Collection<InternalSignature> intSigs) {
